...
return array(
    ...
    "admin.setting.systemName"       => "프로그램 명",
    "admin.setting.systemNameDesc"   => "프로그램 로고 제목",
    "admin.setting.systemDesc"       => "프로그램 설명",
    ...
    "admin.storage.ossKeyDesc"       => "Alibaba Cloud 계정의 액세스 키 ID, Alibaba Cloud에서 생성 또는 확인 [제어판-액세스 키 관리]",
    "admin.storage.ossSecretDesc"    => "Alibaba Cloud 계정의 액세스 키 비밀",
    "admin.storage.qiniuDomain"      => "Qiniu Space에 의해 바인딩 된 도메인 이름",
    "admin.storage.qiniuKeyDesc"     => "Qiniu 계정의 액세스 키는 Qiniu 클라우드에서 작성하거나 확인하십시오. [제어판-개인 센터-키 관리]",
    ...
    "admin.setting.transferChunkSizeDesc" => "큰 파일 업로드가 권장되고 5M이 권장됩니다.이 값은 다음 구성보다 작아야합니다. 그렇지 않으면 업로드 예외 (업로드 실패, 진행 롤백)가 발생합니다.",
 ...
 post_max_size, 다시 시작해야 함)",
    ...
    "common.pathNotExists"           => "파일이 존재하지 않습니다!",
    ...
    "common.copyright.info"          => "저작권 © <a href=\"https://kodcloud.com/?kodref=%s\" target=\"_blank\">kodcloud.com</a> .",
    ...
    "common.copyright.metaDesc"      => "kodbox (이전의 Mango Cloud KodExplorer)는 업계 최고의 정부 / 기업 개인 클라우드 및 온라인 문서 관리 시스템으로, 안전하고 제어 가능하고 쉽고 편리한 개인 웹 사이트, 회사 개인 클라우드 배포, 네트워크 스토리지, 온라인 문서 관리, 온라인 사무실 등을 제공합니다. 사용하기 쉽고 고도로 사용자 정의 가능한 개인 클라우드 제품. Windows 스타일의 인터페이스와 운영 습관을 채택하고 있으며, 적응없이 빠르게 사용할 수 있으며, 일반적으로 사용되는 수백 가지 파일 형식의 온라인 미리보기, 재생 및 편집을 지원하며 환경 친화적이며 강력하며 시험없이 분리 할 수없는 개인 자산입니다. 클라우드 제품.",
    ...
    "explorer.authNote"              => "참고 : 관리 기능에는 멤버 권한 설정 / 협업 멤버 수정 / 댓글 관리 / 기록 버전 관리가 포함됩니다.주의하십시오! <br/>
 [시스템 관리자] 역할은 권한에 의해 제한되지 않습니다.",
    ...
    "explorer.share.downNum"         => "다운로드 제한",
    ...
    "user.recycleDesc"               => "닫은 후 바로 삭제되므로 열 것을 권장합니다.",
