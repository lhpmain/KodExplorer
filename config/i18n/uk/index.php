...
return array(
    ...
    "admin.setting.systemName"       => "Назва програми",
    "admin.setting.systemNameDesc"   => "Назва логотипу програми",
    "admin.setting.systemDesc"       => "Опис програми",
    ...
    "admin.storage.ossKeyDesc"       => "Ідентифікатор ключа доступу облікового запису Alibaba Cloud, створіть або перегляньте в хмарі Alibaba [Панель управління - керування ключами доступу]",
    ...
    "admin.storage.qiniuKeyDesc"     => "Ключ доступу для облікового запису Qiniu, будь ласка, створіть або перегляньте у хмарі Qiniu [Панель управління - персональний центр-керування ключами]",
    ...
    "admin.setting.transferChunkSizeDesc" => "Рекомендується завантаження великих файлів, рекомендується 5М; це значення має бути меншим, ніж наступна конфігурація, інакше це спричинить виняток при завантаженні (помилка завантаження, відкат прогресу)",
 ...
 post_max_size, потрібно перезапустити)",
    ...
    "common.pathNotExists"           => "Файл не існує!",
    ...
    "common.copyright.metaDesc"      => "kodbox (раніше Mango Cloud KodExplorer) - це провідна приватна хмара та система управління документами в Інтернеті. Прості у користуванні приватні хмарні продукти, що легко налаштовуються. Він використовує інтерфейс у стилі Windows та звички роботи, його можна швидко використовувати без адаптації, він підтримує попередній перегляд, відтворення та редагування сотень часто використовуваних форматів файлів. Хмарні продукти.",
    ...
    "explorer.zipingTips"            => "Видалення операції, зачекайте ...",
    ...
    "explorer.authNote"              => "Примітка. Функція управління включає встановлення дозволів для членів / зміну членів спільної роботи / управління коментарями / управління історичними версіями, будьте обережні! <br/>
 [System Administrator] Роль не обмежена жодними дозволами;",
    ...
    "explorer.share.downNum"         => "Обмежити завантаження",
    ...
    "user.recycleDesc"               => "Він буде видалений безпосередньо після закриття. Рекомендується відкрити його.",
