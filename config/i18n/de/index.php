...
return array(
    ...
    "admin.setting.systemName"       => "Programmname",
    "admin.setting.systemNameDesc"   => "Titel des Programmlogos",
    "admin.setting.systemDesc"       => "Programmbeschreibung",
    ...
    "admin.storage.ossKeyDesc"       => "Zugriffsschlüssel-ID des Alibaba Cloud-Kontos, bitte in Alibaba Cloud erstellen oder anzeigen [Systemsteuerung - Zugriffsschlüsselverwaltung]",
    ...
    "admin.storage.qiniuKeyDesc"     => "Access Key für Qiniu-Konto, bitte erstellen oder in Qiniu Cloud anzeigen [Systemsteuerung-Personal Center-Key-Verwaltung]",
    ...
    "admin.setting.transferChunkSizeDesc" => "Upload großer Dateien wird empfohlen, 5 MB werden empfohlen; dieser Wert muss unter der folgenden Konfiguration liegen; andernfalls wird eine Upload-Ausnahme ausgelöst (Upload-Fehler, Fortschritts-Rollback)",
 ...
 post_max_size, muss neu gestartet werden)",
    ...
    "common.pathNotExists"           => "Die Datei existiert nicht!",
    ...
    "common.copyright.metaDesc"      => "kodbox (ehemals Mango Cloud KodExplorer) ist das branchenweit führende Private-Cloud- und Online-Dokumentenmanagementsystem für Behörden und Unternehmen. Es bietet sichere und kontrollierbare, einfache und bequeme persönliche Websites, die Bereitstellung von Private-Clouds für Unternehmen, Netzwerkspeicher, Online-Dokumentenmanagement, Online-Office usw. Benutzerfreundliche, stark anpassbare Private Cloud-Produkte. Es übernimmt Windows-ähnliche Benutzeroberflächen und Betriebsgewohnheiten. Es kann ohne Anpassung schnell verwendet werden. Es unterstützt die Online-Vorschau, Wiedergabe und Bearbeitung von Hunderten von häufig verwendeten Dateiformaten. Es ist umweltfreundlich und leistungsstark. Es ist ein privates Eigentum, das nicht ohne Prüfung getrennt werden kann. Cloud-Produkte.",
    ...
    "explorer.zipingTips"            => "Entpacken, bitte warten ...",
    ...
    "explorer.authNote"              => "Hinweis: Die Verwaltungsfunktion umfasst das Festlegen von Mitgliedsberechtigungen / das Ändern von Mitgliedern für die Zusammenarbeit / das Verwalten von Kommentaren / das Verwalten historischer Versionen. Bitte seien Sie vorsichtig! <br/>
 Die Rolle [Systemadministrator] ist nicht durch Berechtigungen eingeschränkt.",
    ...
    "explorer.share.downNum"         => "Beschränken Sie Downloads",
    ...
    "user.recycleDesc"               => "Es wird direkt nach dem Schließen gelöscht. Es wird empfohlen, es zu öffnen.",
