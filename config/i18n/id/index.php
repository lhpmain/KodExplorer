...
return array(
    ...
    "admin.setting.systemName"       => "Nama program",
    "admin.setting.systemNameDesc"   => "Judul logo program",
    "admin.setting.systemDesc"       => "Deskripsi program",
    ...
    "admin.storage.ossKeyDesc"       => "ID Kunci Akses akun Alibaba Cloud, silakan buat atau lihat di Alibaba Cloud [Control Panel-Access Key Management]",
    ...
    "admin.storage.qiniuKeyDesc"     => "Kunci Akses untuk akun Qiniu, silakan buat atau lihat di Qiniu Cloud [Control Panel-Personal Center-Key Management]",
    ...
    "admin.setting.transferChunkSizeDesc" => "Disarankan mengunggah file besar, 5M dianjurkan, nilai ini harus kurang dari konfigurasi berikut; jika tidak, akan menyebabkan pengecualian unggahan (kegagalan unggahan, kembalikan rollback)",
 ...
 post_max_size, perlu memulai ulang)",
    ...
    "common.pathNotExists"           => "File tidak ada!",
    ...
    "common.copyright.info"          => "Hak Cipta © <a href=\"https://kodcloud.com/?kodref=%s\" target=\"_blank\">kodcloud.com</a> .",
    ...
    "common.copyright.metaDesc"      => "kodbox (sebelumnya Mango Cloud KodExplorer) adalah cloud privat pemerintah / perusahaan terkemuka dan sistem manajemen dokumen online. Produk cloud pribadi yang mudah digunakan dan sangat dapat disesuaikan. Ini mengadopsi antarmuka windows-style dan kebiasaan operasi. Ini dapat digunakan dengan cepat tanpa adaptasi. Ini mendukung pratinjau online, pemutaran dan pengeditan ratusan format file yang umum digunakan. Ini ramah lingkungan dan kuat. Ini adalah properti pribadi yang tidak dapat dipisahkan tanpa uji coba. Produk cloud.",
    ...
    "explorer.authNote"              => "Catatan: Fungsi manajemen termasuk mengatur izin anggota / memodifikasi anggota kolaboratif / manajemen komentar / manajemen versi historis, harap berhati-hati! <br/>
 [Administrator Sistem] Peran tidak dibatasi oleh izin apa pun;",
    ...
    "explorer.share.downNum"         => "Batasi unduhan",
    ...
    "user.recycleDesc"               => "Ini akan dihapus langsung setelah ditutup. Disarankan untuk membukanya.",
