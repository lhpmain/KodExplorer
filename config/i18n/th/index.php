...
return array(
    ...
    "admin.setting.systemName"       => "ชื่อโปรแกรม",
    "admin.setting.systemNameDesc"   => "ชื่อโลโก้โปรแกรม",
    "admin.setting.systemDesc"       => "คำอธิบายโปรแกรม",
    ...
    "admin.storage.ossKeyDesc"       => "เข้าถึงรหัสคีย์ของบัญชี Alibaba Cloud โปรดสร้างหรือดูใน Alibaba Cloud [การจัดการคีย์การเข้าถึงแผงควบคุม]",
    ...
    "admin.storage.qiniuKeyDesc"     => "รหัสการเข้าถึงสำหรับบัญชี Qiniu โปรดสร้างหรือดูใน Qiniu Cloud [แผงควบคุม - การจัดการศูนย์ส่วนบุคคล - คีย์]",
    ...
    "admin.setting.transferChunkSizeDesc" => "แนะนำให้อัปโหลดไฟล์ขนาดใหญ่แนะนำ 5M ค่านี้ต้องน้อยกว่าการกำหนดค่าต่อไปนี้มิฉะนั้นจะทำให้เกิดข้อยกเว้นการอัปโหลด",
 ...
 post_max_size ต้องเริ่มต้นใหม่)",
    ...
    "common.pathNotExists"           => "ไฟล์นี้ไม่มีอยู่!",
    ...
    "common.copyright.info"          => "ลิขสิทธิ์© <a href=\"https://kodcloud.com/?kodref=%s\" target=\"_blank\">kodcloud.com</a>",
    ...
    "common.copyright.metaDesc"      => "kodbox (เดิมชื่อ Mango Cloud KodExplorer) เป็นระบบคลาวด์ส่วนตัวของรัฐบาล / องค์กรเอกชนและระบบจัดการเอกสารออนไลน์ ผลิตภัณฑ์คลาวด์ส่วนตัวที่ใช้งานง่ายและปรับแต่งได้สูง มันใช้อินเทอร์เฟซแบบ windows และนิสัยการทำงานมันสามารถใช้ได้อย่างรวดเร็วโดยไม่ต้องดัดแปลงมันรองรับการแสดงตัวอย่างออนไลน์การเล่นและการแก้ไขรูปแบบไฟล์ที่ใช้กันทั่วไปหลายร้อยรูปแบบมันเป็นมิตรกับสิ่งแวดล้อมและมีประสิทธิภาพ ผลิตภัณฑ์คลาวด์",
    ...
    "explorer.authNote"              => "หมายเหตุ: ฟังก์ชั่นการจัดการรวมถึงการตั้งค่าการอนุญาตของสมาชิก / การแก้ไขสมาชิกที่ทำงานร่วมกัน / การจัดการความคิดเห็น / การจัดการเวอร์ชั่นในอดีตโปรดใช้ความระมัดระวัง! <br/>
 [ผู้ดูแลระบบ] บทบาทไม่ได้ถูก จำกัด โดยการอนุญาตใด ๆ",
    ...
    "explorer.share.downNum"         => "จำกัด การดาวน์โหลด",
    ...
    "user.recycleDesc"               => "มันจะถูกลบโดยตรงหลังจากปิดขอแนะนำให้เปิด",
