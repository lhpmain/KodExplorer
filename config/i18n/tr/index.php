...
return array(
    ...
    "admin.setting.systemName"       => "Program adı",
    "admin.setting.systemNameDesc"   => "Program logosu başlığı",
    "admin.setting.systemDesc"       => "Program açıklaması",
    ...
    "admin.storage.ossKeyDesc"       => "Alibaba Cloud hesabının erişim anahtarı kimliği, lütfen Alibaba Cloud&#39;da oluşturun veya görüntüleyin [Kontrol Paneli-Erişim Anahtarı Yönetimi]",
    ...
    "admin.storage.qiniuKeyDesc"     => "Qiniu hesabı için Erişim Anahtarı, lütfen Qiniu Cloud&#39;da oluşturun veya görüntüleyin [Kontrol Paneli-Kişisel Merkez-Anahtar Yönetimi]",
    ...
    "admin.setting.transferChunkSizeDesc" => "Büyük dosya yüklemesi önerilir, 5M önerilir; bu değer aşağıdaki yapılandırmadan daha az olmalıdır; aksi takdirde yükleme istisnasına neden olur (yükleme hatası, ilerleme geri alma)",
 ...
 post_max_size, yeniden başlatmanız gerekiyor)",
    ...
    "common.pathNotExists"           => "Dosya mevcut değil!",
    ...
    "common.copyright.info"          => "Telif Hakkı © <a href=\"https://kodcloud.com/?kodref=%s\" target=\"_blank\">kodcloud.com</a> .",
    ...
    "common.copyright.metaDesc"      => "kodbox (eski adıyla Mango Cloud KodExplorer) güvenli ve kontrol edilebilir, kolay ve kullanışlı kişisel web sitesi, kurumsal özel bulut dağıtımı, ağ depolama, çevrimiçi belge yönetimi, çevrimiçi ofis vb. sağlayan sektörün önde gelen hükümet / kurumsal özel bulut ve çevrimiçi belge yönetim sistemidir. Kullanımı kolay, son derece özelleştirilebilir özel bulut ürünleri. Windows tarzı arayüz ve çalışma alışkanlıklarını benimser, adaptasyon olmadan hızlı bir şekilde kullanılabilir.Yüzlerce kullanılan dosya formatlarının çevrimiçi önizlemesini, oynatılmasını ve düzenlenmesini destekler.Çevre dostu ve güçlüdür, deneme olmadan ayrılamayan özel bir özelliktir. Bulut ürünleri.",
    ...
    "explorer.authNote"              => "Not: Yönetim işlevi, üye izinlerini ayarlama / ortak üyeleri değiştirme / yorum yönetimi / geçmiş sürüm yönetimini içerir, lütfen dikkatli olun! <br/>
 [Sistem Yöneticisi] Rol herhangi bir izinle sınırlı değildir;",
    ...
    "explorer.share.downNum"         => "İndirme işlemlerini sınırla",
    ...
    "user.recycleDesc"               => "Kapattıktan sonra doğrudan silinir. Açılması önerilir.",
