...
return array(
    ...
    "admin.setting.user"             => "Registration and Login",
    ...
    "admin.setting.systemName"       => "Program name",
    "admin.setting.systemNameDesc"   => "Program logo title",
    "admin.setting.systemDesc"       => "Program description",
    ...
    "admin.setting.emailDesc"        => "Set up a mail server for user registration, password recovery email sending",
    ...
    "admin.member.groupConfig"       => "Bulk setup groups",
    ...
    "admin.member.spaceTips"         => "0 is not limited",
    "admin.member.spaceTipsDefault"  => "(GB) 0 is not limited",
    "admin.member.spaceTipsFull"     => "Not limited",
    ...
    "admin.auth.canUpload"           => "Upload Download",
    ...
    "admin.plugin.type"              => "Classification",
    "admin.plugin.typeFile"          => "File enhancement",
    "admin.plugin.typeSafe"          => "Security tools",
    ...
    "admin.storage.ossKeyDesc"       => "Access Key ID of Alibaba Cloud, please create or view in Alibaba Cloud [Control Panel-Access Key Management]",
    "admin.storage.ossSecretDesc"    => "Access Key Secret of Alibaba Cloud",
    "admin.storage.qiniuDomain"      => "Domain name bound by Qiniu Space",
    "admin.storage.qiniuKeyDesc"     => "Access Key of Qiniu, please create or view in Qiniu Cloud [Control Panel-Personal Center-Key Management]",
    ...
    "admin.install.defSetError"      => "System configuration failed to add",
    ...
    "admin.install.defaultUpdate"    => "System configuration information update",
    ...
    "admin.install.setInfo"          => "System configuration information",
    ...
    "admin.setting.transferChunkSizeDesc" => "Large file upload is recommended, 5M is recommended; this value must be less than the following configuration; otherwise it will cause upload exception (upload failure, progress rollback)",
 ...
 post_max_size, need to restart)",
    ...
    "common.attributeInfo"           => "Attribute information",
    ...
    "common.tips"                    => "Tips",
    "common.systemSet"               => "System Configuration",
    ...
    "common.pathNotExists"           => "File does not exist!",
    ...
    "common.copyright.metaDesc"      => "Kodbox (formerly Mango Cloud KodExplorer) is the industry&#39;s leading government / enterprise private cloud and online document management system, providing secure and controllable, easy and convenient personal website, corporate private cloud deployment, network storage, online document management, online office, etc. Easy-to-use, highly customizable private cloud products. It adopts windows-style interface and operating habits. It can be used quickly without adaptation. It supports online preview, playback and editing of hundreds of commonly used file formats. It is environment-friendly and powerful. It is a private property that cannot be separated without trial. Cloud products.",
    ...
    "explorer.zipingTips"            => "Unzipping operation, please wait ...",
    ...
    "explorer.authNote"              => "Note: The management function includes setting member permissions / modifying collaborative members / comment management / historical version management, please exercise caution! <br/>
 [System Administrator] Role is not restricted by any permissions;",
    ...
    "explorer.file.action"           => "Operating",
    ...
    "explorer.app.openWindow"        => "Open in a new window",
    "explorer.app.openDialog"        => "Dialog box opens",
    ...
    "explorer.share.downNum"         => "Limit downloads",
    ...
    "user.recycleDesc"               => "It will be deleted directly after closing.It is recommended to open it.",
    "user.animateDesc"               => "You can consider closing when the operation is not smooth",
    ...
    "user.fileSelectDesc"            => "Left-click on the file icon, shortcut to the right-click menu",
