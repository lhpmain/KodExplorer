...
return array(
    ...
    "admin.setting.systemName"       => "اسم البرنامج",
    "admin.setting.systemNameDesc"   => "عنوان شعار البرنامج",
    "admin.setting.systemDesc"       => "وصف البرنامج",
    ...
    "admin.storage.ossKeyDesc"       => "معرف مفتاح الوصول لحساب Alibaba Cloud ، يرجى إنشاء أو عرض في Alibaba Cloud [إدارة التحكم في الوصول إلى لوحة المفاتيح]",
    "admin.storage.ossSecretDesc"    => "مفتاح الوصول سر حساب علي بابا الغيمة",
    "admin.storage.qiniuDomain"      => "اسم المجال ملزمة Qiniu الفضاء",
    "admin.storage.qiniuKeyDesc"     => "مفتاح الوصول لحساب Qiniu ، يرجى إنشاء أو عرض في Qiniu Cloud [لوحة التحكم - إدارة مركز - إدارة المفاتيح]",
    ...
    "admin.setting.transferChunkSizeDesc" => "يوصى بتحميل الملفات الكبيرة ، يوصى بـ 5 ملايين ؛ يجب أن تكون هذه القيمة أقل من التكوين التالي ؛ وإلا فإنها ستتسبب في استثناء التحميل (فشل التحميل ، تراجع التقدم)",
 ...
 post_max_size ، تحتاج إلى إعادة التشغيل)",
    ...
    "common.pathNotExists"           => "الملف غير موجود!",
    ...
    "common.copyright.info"          => "حقوق الطبع والنشر © <a href=\"https://kodcloud.com/?kodref=%s\" target=\"_blank\">kodcloud.com</a> .",
    ...
    "common.copyright.metaDesc"      => "kodbox (المعروف سابقًا باسم Mango Cloud KodExplorer) هو نظام إدارة المستندات والاتصال عبر الإنترنت في القطاع الحكومي / المؤسسي ، ويوفر موقعًا شخصيًا آمنًا وقابل للتحكم ، سهلًا وملائمًا ، النشر السحابي الخاص للشركات ، تخزين الشبكة ، إدارة المستندات عبر الإنترنت ، مكتب الإنترنت ، إلخ. منتجات سحابية خاصة سهلة الاستخدام وقابلة للتخصيص بدرجة عالية. تعتمد واجهة على غرار windows وعادات التشغيل ، ويمكن استخدامها بسرعة دون تكييف ، فهي تدعم المعاينة عبر الإنترنت ، وتشغيل وتحرير مئات تنسيقات الملفات الشائعة الاستخدام ، وهي صديقة للبيئة وقوية ، وهي ملكية خاصة لا يمكن فصلها دون تجربة. المنتجات السحابية.",
    ...
    "explorer.authNote"              => "ملاحظة: تتضمن وظيفة الإدارة تعيين أذونات الأعضاء / تعديل الأعضاء التعاونية / إدارة التعليقات / إدارة الإصدار التاريخي ، يرجى توخي الحذر! <br/>
 [مسؤول النظام] الدور ليس مقيدًا بأي أذونات ؛",
    ...
    "explorer.share.downNum"         => "الحد من التنزيلات",
    ...
    "user.recycleDesc"               => "سيتم حذفه مباشرة بعد الإغلاق. من المستحسن فتحه.",
