...
return array(
    ...
    "admin.setting.systemName"       => "Название программы",
    "admin.setting.systemNameDesc"   => "Название логотипа программы",
    "admin.setting.systemDesc"       => "Описание программы",
    ...
    "admin.storage.ossKeyDesc"       => "Идентификатор ключа доступа к учетной записи Alibaba Cloud, пожалуйста, создайте или просмотрите в Alibaba Cloud [Панель управления-Управление ключами доступа]",
    ...
    "admin.storage.qiniuKeyDesc"     => "Ключ доступа для учетной записи Qiniu, пожалуйста, создайте или просмотрите в Qiniu Cloud [Панель управления-Персональный центр-Управление ключами]",
    ...
    "admin.setting.transferChunkSizeDesc" => "Рекомендуется загрузка большого файла, рекомендуется 5M, это значение должно быть меньше, чем в следующей конфигурации, в противном случае это приведет к исключению при загрузке (ошибка загрузки, откат выполнения)",
 ...
 post_max_size, нужно перезагрузить)",
    ...
    "common.pathNotExists"           => "Файл не существует!",
    ...
    "common.copyright.metaDesc"      => "kodbox (ранее Mango Cloud KodExplorer) - это ведущая в отрасли система управления частным облаком для государственных и корпоративных систем и управления документами в Интернете. Простые в использовании, настраиваемые продукты для частного облака. Он использует интерфейс в стиле Windows и привычки к работе. Его можно быстро использовать без адаптации. Он поддерживает онлайн-просмотр, воспроизведение и редактирование сотен часто используемых форматов файлов. Он экологичен и эффективен. Облачные продукты.",
    ...
    "explorer.authNote"              => "Примечание: функция управления включает в себя настройку полномочий участников / изменение участников совместной работы / управление комментариями / управление исторической версией, пожалуйста, будьте осторожны! <br/>
 [Системный администратор] Роль не ограничена никакими разрешениями;",
    ...
    "explorer.share.downNum"         => "Ограничить загрузки",
    ...
    "user.recycleDesc"               => "Он будет удален сразу после закрытия. Рекомендуется открыть его.",
