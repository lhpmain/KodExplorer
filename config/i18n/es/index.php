...
return array(
    ...
    "admin.setting.systemName"       => "Nombre del programa",
    "admin.setting.systemNameDesc"   => "Título del logo del programa",
    "admin.setting.systemDesc"       => "Descripción del programa",
    ...
    "admin.storage.ossKeyDesc"       => "ID de clave de acceso de la cuenta de Alibaba Cloud, cree o visualice en Alibaba Cloud [Panel de control-Gestión de claves de acceso]",
    ...
    "admin.storage.qiniuKeyDesc"     => "Clave de acceso para la cuenta Qiniu, cree o visualice en Qiniu Cloud [Panel de control-Centro personal-Gestión de claves]",
    ...
    "admin.setting.transferChunkSizeDesc" => "Se recomienda la carga de archivos grandes, se recomiendan 5M; este valor debe ser menor que la siguiente configuración; de lo contrario, causará una excepción de carga (falla de carga, retroceso del progreso)",
 ...
 post_max_size, necesita reiniciar)",
    ...
    "common.pathNotExists"           => "¡El archivo no existe!",
    ...
    "common.copyright.info"          => "Derechos de autor © <a href=\"https://kodcloud.com/?kodref=%s\" target=\"_blank\">kodcloud.com</a> .",
    ...
    "common.copyright.metaDesc"      => "kodbox (anteriormente Mango Cloud KodExplorer) es el sistema líder en la industria de administración de documentos en línea y de nube privada gubernamental / empresarial de la industria. Productos de nube privada altamente personalizables y fáciles de usar. Adopta una interfaz de estilo Windows y hábitos de operación. Se puede usar rápidamente sin adaptación. Es compatible con la vista previa en línea, la reproducción y la edición de cientos de formatos de archivo de uso común. Es amigable con el medio ambiente y potente. Productos en la nube.",
    ...
    "explorer.zipingTips"            => "Operación de descompresión, por favor espere ...",
    ...
    "explorer.authNote"              => "Nota: La función de gestión incluye la configuración de permisos de miembros / modificación de miembros colaborativos / gestión de comentarios / gestión de versiones históricas, ¡tenga cuidado! <br/>
 [Administrador del sistema] El rol no está restringido por ningún permiso;",
    ...
    "explorer.share.downNum"         => "Limitar descargas",
    ...
    "user.recycleDesc"               => "Se eliminará directamente después del cierre. Se recomienda abrirlo.",
