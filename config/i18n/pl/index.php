...
return array(
    ...
    "admin.setting.systemName"       => "Nazwa programu",
    "admin.setting.systemNameDesc"   => "Tytuł logo programu",
    "admin.setting.systemDesc"       => "Opis programu",
    ...
    "admin.storage.ossKeyDesc"       => "Identyfikator klucza dostępu do konta Alibaba Cloud, należy utworzyć lub wyświetlić w Alibaba Cloud [Panel sterowania - zarządzanie kluczami dostępu]",
    ...
    "admin.storage.qiniuKeyDesc"     => "Klucz dostępu do konta Qiniu, należy utworzyć lub wyświetlić w chmurze Qiniu [Panel sterowania-Personal Center-Key Management]",
    ...
    "admin.setting.transferChunkSizeDesc" => "Zalecane jest przesyłanie dużych plików, zalecane 5M; ta wartość musi być mniejsza niż poniższa konfiguracja; w przeciwnym razie spowoduje to wyjątek przesyłania (błąd przesyłania, cofanie postępu)",
 ...
 post_max_size, trzeba zrestartować)",
    ...
    "common.pathNotExists"           => "Plik nie istnieje!",
    ...
    "common.copyright.info"          => "Prawa autorskie © <a href=\"https://kodcloud.com/?kodref=%s\" target=\"_blank\">kodcloud.com</a> .",
    ...
    "common.copyright.metaDesc"      => "kodbox (wcześniej Mango Cloud KodExplorer) jest wiodącym w branży prywatnym systemem zarządzania chmurą i dokumentami online dla instytucji rządowych / korporacyjnych, zapewniającym bezpieczną i kontrolowaną, łatwą i wygodną osobistą stronę internetową, wdrożenie prywatnej chmury korporacyjnej, przechowywanie w sieci, zarządzanie dokumentami online, biuro online itp. Łatwe w użyciu, wysoce konfigurowalne produkty w chmurze prywatnej. Przyjmuje interfejs w stylu Windows i nawyki działania. Można go szybko używać bez adaptacji. Obsługuje podgląd online, odtwarzanie i edycję setek najczęściej używanych formatów plików. Jest przyjazny dla środowiska i wydajny. Produkty w chmurze.",
    ...
    "explorer.zipingTips"            => "Rozpakowanie operacji, proszę czekać ...",
    ...
    "explorer.authNote"              => "Uwaga: Funkcja zarządzania obejmuje ustawianie uprawnień członków / modyfikowanie członków współpracujących / zarządzanie komentarzami / zarządzanie wersją historyczną, zachowaj ostrożność! <br/>
 [Administrator systemu] Rola nie jest ograniczona żadnymi uprawnieniami;",
    ...
    "explorer.share.downNum"         => "Ogranicz pobieranie",
    ...
    "user.recycleDesc"               => "Zostanie usunięty bezpośrednio po zamknięciu. Zaleca się, aby go otworzyć.",
