...
return array(
    ...
    "admin.setting.systemName"       => "Tên chương trình",
    "admin.setting.systemNameDesc"   => "Tiêu đề logo chương trình",
    "admin.setting.systemDesc"       => "Mô tả chương trình",
    ...
    "admin.storage.ossKeyDesc"       => "ID khóa truy cập của tài khoản Cloud Cloud, vui lòng tạo hoặc xem trong Alibaba Cloud [Bảng điều khiển - Quản lý khóa truy cập]",
    ...
    "admin.storage.qiniuKeyDesc"     => "Khóa truy cập cho tài khoản Qiniu, vui lòng tạo hoặc xem trong Qiniu Cloud [Bảng điều khiển - Trung tâm cá nhân - Quản lý khóa]",
    ...
    "admin.setting.transferChunkSizeDesc" => "Nên tải lên tệp lớn, khuyến nghị 5M, giá trị này phải nhỏ hơn cấu hình sau; nếu không, nó sẽ gây ra ngoại lệ tải lên (lỗi tải lên, quá trình khôi phục tiến độ)",
 ...
 post_max_size, cần khởi động lại)",
    ...
    "common.pathNotExists"           => "Các tập tin không tồn tại!",
    ...
    "common.copyright.info"          => "Bản quyền © <a href=\"https://kodcloud.com/?kodref=%s\" target=\"_blank\">kodcloud.com</a> .",
    ...
    "common.copyright.metaDesc"      => "kodbox (trước đây là Mango Cloud KodExplorer) là hệ thống quản lý tài liệu trực tuyến và đám mây riêng của chính phủ / doanh nghiệp. Các sản phẩm đám mây riêng dễ sử dụng, tùy biến cao. Nó chấp nhận giao diện kiểu windows và thói quen vận hành. Nó có thể được sử dụng nhanh chóng mà không cần điều chỉnh. Nó hỗ trợ xem trước trực tuyến, phát lại và chỉnh sửa hàng trăm định dạng tệp thường được sử dụng. Nó thân thiện với môi trường và mạnh mẽ. Đây là một tài sản riêng không thể tách rời mà không cần dùng thử. Sản phẩm đám mây.",
    ...
    "explorer.authNote"              => "Lưu ý: Chức năng quản lý bao gồm thiết lập quyền thành viên / sửa đổi thành viên hợp tác / quản lý nhận xét / quản lý phiên bản lịch sử, vui lòng thận trọng! <br/>
 [Quản trị viên hệ thống] Vai trò không bị hạn chế bởi bất kỳ quyền nào;",
    ...
    "explorer.share.downNum"         => "Giới hạn tải xuống",
    ...
    "user.recycleDesc"               => "Nó sẽ bị xóa trực tiếp sau khi đóng. Nên mở nó.",
