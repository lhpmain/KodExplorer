...
return array(
    ...
    "admin.setting.systemName"       => "プログラム名",
    "admin.setting.systemNameDesc"   => "プログラムのロゴのタイトル",
    "admin.setting.systemDesc"       => "プログラムの説明",
    ...
    "admin.storage.ossKeyDesc"       => "Alibaba CloudアカウントのアクセスキーID。AlibabaCloudで作成または表示してください[コントロールパネル-アクセスキー管理]",
    "admin.storage.ossSecretDesc"    => "Alibaba CloudアカウントのKey Secret",
    "admin.storage.qiniuDomain"      => "Qiniu Spaceによってバインドされたドメイン名",
    "admin.storage.qiniuKeyDesc"     => "Qiniuアカウントのアクセスキーは、Qiniu Cloudで作成または表示してください[コントロールパネル-パーソナルセンター-キー管理]",
    ...
    "admin.setting.transferChunkSizeDesc" => "大きなファイルのアップロードが推奨され、5Mが推奨されます;この値は以下の構成より小さくなければなりません;そうでない場合、アップロード例外（アップロードの失敗、進行状況のロールバック）が発生します",
 ...
 post_max_size、再起動が必要）",
    ...
    "common.pathNotExists"           => "ファイルが存在しません！",
    ...
    "common.copyright.info"          => "著作権© <a href=\"https://kodcloud.com/?kodref=%s\" target=\"_blank\">kodcloud.com</a> 。",
    ...
    "common.copyright.metaDesc"      => "kodbox（以前のMango Cloud KodExplorer）は、業界をリードする政府/エンタープライズプライベートクラウドおよびオンラインドキュメント管理システムであり、安全で制御可能で、簡単で便利な個人Webサイト、企業プライベートクラウドの展開、ネットワークストレージ、オンラインドキュメント管理、オンラインオフィスなどを提供します。使いやすく、高度にカスタマイズ可能なプライベートクラウド製品。 Windowsスタイルのインターフェイスと操作習慣を採用しています。適応せずにすばやく使用できます。何百もの一般的に使用されるファイル形式のオンラインプレビュー、再生、編集をサポートします。環境に優しく強力です。試用版なしでは分離できないプライベートプロパティです。クラウド製品。",
    ...
    "explorer.authNote"              => "注：管理機能には、メンバーのアクセス許可の設定/共同メンバーの変更/コメント管理/履歴バージョン管理が含まれます。注意してください！ <br/>
 [システム管理者]役割は権限によって制限されません。",
    ...
    "explorer.share.downNum"         => "ダウンロードを制限する",
    ...
    "user.recycleDesc"               => "閉じるとすぐに削除されます。開くことをお勧めします。",
