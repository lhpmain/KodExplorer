...
return array(
    ...
    "admin.setting.systemName"       => "程序名称",
    "admin.setting.systemNameDesc"   => "程序logo标题",
    "admin.setting.systemDesc"       => "程序描述",
    "admin.setting.pathHidden"       => "目录排除",
    ...
    "admin.storage.ossKeyDesc"       => "阿里云账号的Access Key ID，请在阿里云【控制台-Access Key管理】中创建或查看",
    "admin.storage.ossSecretDesc"    => "阿里云账号的Access Key Secret，获取方法同上",
    "admin.storage.qiniuDomain"      => "七牛空间绑定的域名",
    "admin.storage.qiniuKeyDesc"     => "七牛账号的Access Key，请在七牛云【控制台-个人中心-密钥管理】中创建或查看",
    ...
    "admin.setting.transferChunkSizeDesc" => "大文件切片上传,推荐5M; 此值必须小于下述配置;否则会引起上传异常(上传失败,进度回退)",
...
post_max_size,需要重启)",
    ...
    "common.copyright.desc"          => "kodbox是一款备受好评的web文档管理系统,原名KodExplorer，你可以用它来做内部文档管理或共享、也可以用来管理服务器上的网站，取代Ftp，甚至可以当作webIDE直接在线开发。同时你也可以将此程序二次开发整合到你现有的系统。",
    ...
    "common.copyright.metaDesc"      => "kodbox可道云(原芒果云 KodExplorer)是业内领先的政务/企业私有云和在线文档管理系统，为个人网站、企业私有云部署、网络存储、在线文档管理、在线办公等提供安全可控，简便易用、可高度定制的私有云产品。采用windows风格界面、操作习惯，无需适应即可快速上手，支持几百种常用文件格式的在线预览、播放和编辑，环境友好，功能强大，是一款一经试用，就再也离不开的私有云产品。",
    ...
    "explorer.authNote"              => "注: 管理功能包含设置成员权限/修改协作成员/评论管理/历史版本管理,请谨慎操作！<br/> 
[系统管理员]角色不受任何权限限制;",
    ...
    "user.recycleDesc"               => "关闭后删除会直接物理删除,建议开启",
