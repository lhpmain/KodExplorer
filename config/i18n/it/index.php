...
return array(
    ...
    "admin.setting.systemName"       => "Nome del programma",
    "admin.setting.systemNameDesc"   => "Programma il logo del titolo",
    "admin.setting.systemDesc"       => "Descrizione del programma",
    ...
    "admin.setting.emailHostDesc"    => "Server Cassette postali, ad esempio:",
    ...
    "admin.setting.emailSendDesc"    => "Indirizzo email di sistema",
    "admin.setting.emailPwd"         => "Password e-mail",
    "admin.setting.emailPwdInput"    => "Si prega di inserire la password e-mail",
    "admin.setting.emailPwdTips"     => "Si prega di inserire la password e-mail",
    ...
    "admin.member.groupConfig"       => "Reparto di installazione in blocco",
    ...
    "admin.member.groupRemoveTips"   => "Gli utenti di questo gruppo di utenti non possono accedere dopo l&#39;eliminazione <br/> (È necessario ripristinare il gruppo utenti)",
    "admin.member.memberRemoveTips"  => "La directory utente verrà svuotata dopo l&#39;eliminazione",
    ...
    "admin.auth.removeAction"        => "Taglia / taglia / sposta",
    ...
    "admin.plugin.detil"             => "descrizione",
    ...
    "admin.storage.type"             => "Metodo di archiviazione",
    ...
    "admin.storage.delConfig"        => "Elimina configurazione",
    ...
    "admin.storage.serverDesc"       => "Indirizzo IP",
    ...
    "admin.storage.ossKeyDesc"       => "Accedi all&#39;ID chiave dell&#39;account Alibaba Cloud, crea o visualizza in Alibaba Cloud [Pannello di controllo-Gestione chiavi di accesso]",
    ...
    "admin.storage.qiniuKeyDesc"     => "Chiave di accesso per l&#39;account Qiniu, crea o visualizza in Qiniu Cloud [Pannello di controllo-Centro personale-Gestione chiavi]",
    ...
    "admin.install.cacheError"       => "Errore di connessione delle impostazioni della cache, si prega di controllare la configurazione",
    "admin.install.cacheConnectError" => "Le impostazioni della cache non possono connettersi al server, controllare la configurazione",
    ...
    "admin.install.ifDelDb"          => "Ci sono dati nel database che hai specificato, il sistema cancellerà automaticamente i vecchi dati. Vuoi continuare?",
    ...
    "admin.install.dbTypeError"      => "Il tipo di database selezionato non è disponibile, installa l&#39;estensione pertinente o scegli un altro tipo",
    ...
    "admin.install.needWirte"        => "Autorizzazioni di lettura e scrittura richieste",
    ...
    "admin.install.cacheType"        => "Metodo di memorizzazione nella cache dei dati",
    "admin.install.cacheTypeDesc"    => "Utilizzato per memorizzare nella cache dati comuni e accelerare l&#39;accesso al sistema",
    ...
    "admin.log.stausUser"            => "Abilita e disabilita gli utenti",
    ...
    "admin.setting.transferChunkSizeDesc" => "Si consiglia il caricamento di file di grandi dimensioni, si consiglia 5M; questo valore deve essere inferiore alla seguente configurazione; in caso contrario, si verificherà un&#39;eccezione di caricamento (errore di caricamento, rollback dell&#39;avanzamento)",
 ...
 post_max_size, è necessario riavviare)",
    ...
    "common.pathNotExists"           => "Il file non esiste!",
    ...
    "common.env.invalidExt"          => "L&#39;estensione non è disponibile",
    ...
    "common.copyright.info"          => "Copyright © <a href=\"https://kodcloud.com/?kodref=%s\" target=\"_blank\">kodcloud.com</a> .",
    "common.copyright.pre"           => "Powered by kodbox",
    ...
    "common.copyright.metaDesc"      => "kodbox (precedentemente Mango Cloud KodExplorer) è il principale sistema di gestione del cloud privato e dei documenti governativo / aziendale del settore, che offre un sito Web personale sicuro e controllabile, facile e conveniente, l&#39;implementazione del cloud privato aziendale, l&#39;archiviazione di rete, la gestione dei documenti online, l&#39;ufficio online, ecc. Prodotti cloud privati facili da usare e altamente personalizzabili. Adotta l&#39;interfaccia e le abitudini operative in stile Windows. Può essere utilizzato rapidamente senza adattamento. Supporta l&#39;anteprima online, la riproduzione e la modifica di centinaia di formati di file di uso comune. È ecologico e potente. È una proprietà privata che non può essere separata senza prova. Prodotti cloud.",
    "common.copyright.metaCopyright" => "kodcloud.com",
    ...
    "explorer.zipingTips"            => "Operazione di decompressione, attendere ...",
    ...
    "explorer.openWithLoc"           => "Apri localmente",
    ...
    "explorer.moveTop"               => "appiccicoso",
    "explorer.moveBottom"            => "Impostare end",
    ...
    "explorer.addToFavs"             => "Aggiungi ai preferiti",
    ...
    "explorer.authNote"              => "Nota: la funzione di gestione include l&#39;impostazione delle autorizzazioni dei membri / la modifica dei membri collaborativi / la gestione dei commenti / la gestione della versione storica, prestare attenzione! <br/>
 [Amministratore di sistema] Il ruolo non è limitato da alcuna autorizzazione;",
    "explorer.toolbar.rootPath"      => "Il mio documento",
    ...
    "explorer.table.itemPage"        => "Articolo / Pagina",
    ...
    "explorer.search.extNull"        => "Tipi di file illimitati",
    "explorer.search.extDiy"         => "Tipo di file personalizzato",
    ...
    "explorer.share.downNum"         => "Limita i download",
    ...
    "explorer.editor.toolsSelectTips" => "Seleziona prima il contenuto che desideri convertire!",
    ...
    "user.recycleDesc"               => "Verrà eliminato direttamente dopo la chiusura. Si consiglia di aprirlo.",
    ...
    "user.theme.mac"                 => "Mac minimalista bianco",
    "user.theme.win7"                => "Windows 7",
    "user.theme.win10"               => "Windows 10",
    "user.theme.metro"               => "Metro Classic Blue",
    "user.theme.metroGreen"          => "Metro verde chiaro",
    "user.theme.metroPurple"         => "Metro elegante viola",
    "user.theme.metroPink"           => "Metro Rose",
    "user.theme.metroOrange"         => "Metro arancione brillante",
    "user.theme.alphaImage"          => "Luminoso - volare",
    "user.theme.alphaImageSun"       => "Luminoso - Sunset",
    "user.theme.alphaImageSky"       => "Cielo colorato di blu",
