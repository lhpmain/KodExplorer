...
return array(
    ...
    "admin.setting.systemName"       => "Nom du programme",
    "admin.setting.systemNameDesc"   => "Titre du logo du programme",
    "admin.setting.systemDesc"       => "Description du programme",
    ...
    "admin.storage.ossKeyDesc"       => "Clé d’accès ID du compte Alibaba Cloud, veuillez créer ou afficher cette page dans Alibaba Cloud [Panneau de configuration - Gestion des clés d’accès]",
    ...
    "admin.storage.qiniuKeyDesc"     => "Clé d’accès pour le compte Qiniu, veuillez créer ou afficher dans le nuage Qiniu [Panneau de configuration - Centre personnel - Gestion des clés].",
    ...
    "admin.setting.transferChunkSizeDesc" => "Le téléchargement de fichiers volumineux est recommandé, 5 Mo est recommandé; cette valeur doit être inférieure à la configuration suivante; sinon, cela entraînera une exception de téléchargement (échec du téléchargement, restauration de la progression)",
 ...
 post_max_size, besoin de redémarrer)",
    ...
    "common.pathNotExists"           => "Le fichier n&#39;existe pas!",
    ...
    "common.copyright.metaDesc"      => "kodbox (anciennement Mango Cloud KodExplorer) est le principal système de gestion de cloud privé et de documents en ligne du gouvernement / entreprise du secteur. Produits de cloud privé faciles à utiliser et hautement personnalisables. Il adopte une interface de style Windows et des habitudes de fonctionnement. Il peut être utilisé rapidement sans adaptation. Il prend en charge la prévisualisation, la lecture et l&#39;édition en ligne de centaines de formats de fichiers couramment utilisés. Il est respectueux de l&#39;environnement et puissant. Produits cloud.",
    ...
    "explorer.authNote"              => "Remarque: La fonction de gestion comprend la définition des autorisations des membres / la modification des membres collaboratifs / la gestion des commentaires / la gestion des versions historiques, veuillez faire preuve de prudence! <br/>
 [Administrateur système] Le rôle n&#39;est limité par aucune autorisation;",
    ...
    "explorer.share.downNum"         => "Limiter les téléchargements",
    ...
    "user.recycleDesc"               => "Il sera supprimé directement après la fermeture, il est recommandé de l&#39;ouvrir.",
