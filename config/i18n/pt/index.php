...
return array(
    ...
    "admin.setting.systemName"       => "Nome do programa",
    "admin.setting.systemNameDesc"   => "Título do logotipo do programa",
    "admin.setting.systemDesc"       => "Descrição do programa",
    ...
    "admin.storage.ossKeyDesc"       => "ID da chave de acesso da conta do Alibaba Cloud, crie ou visualize no Alibaba Cloud [Painel de controle - Gerenciamento de chaves de acesso]",
    ...
    "admin.storage.qiniuKeyDesc"     => "Chave de acesso para a conta Qiniu, crie ou visualize no Qiniu Cloud [Painel de controle - Central pessoal - Gerenciamento de chaves]",
    ...
    "admin.setting.transferChunkSizeDesc" => "Recomenda-se o upload de arquivos grandes, recomenda-se 5M; esse valor deve ser menor que a seguinte configuração; caso contrário, causará uma exceção de upload (falha no upload, reversão de progresso)",
 ...
 post_max_size, precisa reiniciar)",
    ...
    "common.pathNotExists"           => "O arquivo não existe!",
    ...
    "common.copyright.info"          => "Direitos autorais © <a href=\"https://kodcloud.com/?kodref=%s\" target=\"_blank\">kodcloud.com</a> .",
    ...
    "common.copyright.metaDesc"      => "O kodbox (anteriormente Mango Cloud KodExplorer) é o principal sistema de gerenciamento de documentos on-line / nuvem privada do governo / empresa. Produtos de nuvem privada altamente personalizáveis e fáceis de usar. Adota interface de estilo Windows e hábitos de operação.Pode ser usado rapidamente sem adaptação.Ele suporta pré-visualização, reprodução e edição on-line de centenas de formatos de arquivos comumente usados.É amigável e eficiente em termos de ambiente. Produtos em nuvem.",
    ...
    "explorer.zipingTips"            => "Descompactando a operação, aguarde ...",
    ...
    "explorer.authNote"              => "Nota: A função de gerenciamento inclui a configuração de permissões de membros / modificação de membros colaborativos / gerenciamento de comentários / gerenciamento de versão histórica, tenha cuidado! <br/>
 A função [Administrador do sistema] não é restrita por nenhuma permissão;",
    ...
    "explorer.share.downNum"         => "Limitar downloads",
    ...
    "user.recycleDesc"               => "Ele será excluído diretamente após o fechamento. É recomendável abri-lo.",
